...
using DVLD_Buisness;
using static Test_DVLD_Buisness.clsTestType;
using Test_DVLD.Applications.Local_Driving_License;
...
namespace Test_DVLD.Tests
{
    public partial class frmListTestAppointments : Form
    {
        ...
        private void btnAddNewAppointment_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("There is already an active scheduled test appointment for this application and test type.", "Active Scheduled Test", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            if(LastTest == null)
            {
                ...
                frm1.ShowDialog();
                frmListTestAppointments_Load(sender, e);
                return;
            }

            if(LastTest.TestResult == true)
            {
                MessageBox.Show("This person already passed this test before, you can only retake faild test", "Test Already Passed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
