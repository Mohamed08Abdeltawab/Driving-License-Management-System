...
using Test_DVLD.Licenses.International_Licenses;
using Test_DVLD_Buisness;

namespace Test_DVLD.Applications.International_License
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            {
                MessageBox.Show("Selected Driver already has an active International License, select another one.", "Not Allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
            ...
            //we will use the default constructor to set the application type to New International License.
