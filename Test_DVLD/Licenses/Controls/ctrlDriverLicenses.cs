...
namespace Test_DVLD.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void _LoadInternationalLicenseHistoryo()
        {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if(_Driver == null)
            {
                MessageBox.Show("There is not driver with ID: " + DriverID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            _DriverID = DriverID;
            _LoadLocalLicensesHistory();
            _LoadInternationalLicenseHistoryo();
        }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There is not driver liked with peroson with ID: " + PersonID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
